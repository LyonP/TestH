...
--
-- Table structure for table `tbl_einsatz`
--
...
--
-- Dumping data for table `tbl_einsatz`
--
...
--
-- Table structure for table `tbl_kategorien`
--
...
--
-- Dumping data for table `tbl_kategorien`
--
...
--
-- Table structure for table `tbl_telnos`
--
...
--
-- Dumping data for table `tbl_telnos`
--
...
--
-- Indexes for table `tbl_kategorien`
--
...
--
-- AUTO_INCREMENT for table `tbl_einsatz`
--
ALTER TABLE `tbl_einsatz`
  MODIFY `IDEinsatz` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tbl_kategorien`
--
ALTER TABLE `tbl_kategorien`
...
--
-- AUTO_INCREMENT for table `tbl_telnos`
--
ALTER TABLE `tbl_telnos`
...
--
-- Constraints for table `tbl_einsatz`
--
ALTER TABLE `tbl_einsatz`
...
--
-- Constraints for table `tbl_telnos`
--
ALTER TABLE `tbl_telnos`
